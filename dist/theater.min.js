!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t():"function"==typeof define&&define.amd?define([],t):"object"==typeof exports?exports.theaterJS=t():e.theaterJS=t()}(this,function(){return function(e){function t(r){if(n[r])return n[r].exports;var a=n[r]={exports:{},id:r,loaded:!1};return e[r].call(a.exports,a,a.exports,t),a.loaded=!0,a.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([/*!**************************!*\
  !*** ./src/theaterJS.js ***!
  \**************************/
function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{"default":e}}function a(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function u(){function e(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=arguments.length<=2||void 0===arguments[2]?null:arguments[2],r=(0,i["default"])(e,t,n);return A.casting[r.name]=r,this}function t(e){return A.onStage=e,this}function n(){return A.casting[A.onStage]||null}function r(){var e=this,t=l["default"].toArray(arguments);return t.forEach(function(t){if(f["default"].isString(t)){var n=t.split(":"),a=void 0;n.length>1&&"\\"!==n[0].charAt(n[0].length-1)&&(a=n.shift(),A.options.erase&&r({name:"erase",actor:a}));var u=n.join(":").replace(/\\:/g,":"),o={name:"type",args:[u]};null!=a&&(o.actor=a),r(o)}else f["default"].isFunction(t)?r({name:"callback",args:[t]}):f["default"].isNumber(t)?r(t>0?{name:"wait",args:[t]}:{name:"erase",args:[t]}):f["default"].isArray(t)?t.forEach(function(e){r(e)}):f["default"].isObject(t)&&(f["default"].isArray(t.args)||(t.args=[]),t.args.unshift(c.bind(e)),A.scenario.push(t))}),A.options.autoplay&&u(),this}function u(){return"stopping"===A.status&&(A.status="playing"),"ready"===A.status&&(A.status="playing",c()),this}function o(e){return("ready"===A.status||f["default"].isFunction(e))&&(A.currentScene=-1,"ready"===A.status?u():e()),this}function s(){return A.status="stopping",this}function c(){if("stopping"===A.status)return A.status="ready",this;if("playing"!==A.status)return this;var e=A.scenario[A.currentScene];if(null!=e&&j(e.name+":end",e),A.currentScene+1>=A.scenario.length)return A.status="ready",this;var n=A.scenario[++A.currentScene];switch(n.actor&&t(n.actor),j(n.name+":start",n),n.name){case"type":d.apply(void 0,a(n.args));break;case"erase":g.apply(void 0,a(n.args));break;case"callback":y.apply(void 0,a(n.args));break;case"wait":b.apply(void 0,a(n.args));break;default:console.debug("No scene handler for "+n.name)}return this}function d(e,t){var r=n(),a=A.options.locale,u=A.options.minSpeed,o=A.options.maxSpeed,i=r.displayValue,s=-1,l=!1,c=null,f=null,d=h["default"].map(t);return t=h["default"].strip(t),function g(){var n=h["default"].strip(r.displayValue.substr(i.length));if(n===t)return e();var v=t.substr(0,s+1),m=n!==v,y=r.shouldBeMistaken(n,t,c,f),b=l||!y;if(m&&b)l=!0,c=null,r.displayValue=i+h["default"].inject(n.substr(0,n.length-1),d),s--,f=s;else{l=!1;var x=t.charAt(++s);y&&(x=p["default"].randomCharNear(x,a),null==c&&(c=s)),r.displayValue=i+h["default"].inject(n+x,d)}return setTimeout(g,r.getTypingSpeed(u,o))}(),this}function g(e,t){var r=n(),a=A.options.minSpeed,u=A.options.maxSpeed,o=r.displayValue,i=h["default"].map(o);o=h["default"].strip(o);var s=o.length,l=void 0,c=0;return f["default"].isNumber(t)&&(t>0?l=t:c=o.length+t),function d(){return s===c?e():(r.displayValue=h["default"].inject(o.substr(0,--s),i),setTimeout(d,l||r.getTypingSpeed(a,u)))}(),this}function y(e,t){return t.call(this,e),this}function b(e,t){return setTimeout(e.bind(this),t),this}function x(e,t){return e.split(",").forEach(function(e){e=e.trim(),f["default"].isArray(A.events[e])||(A.events[e]=[]),A.events[e].push(t)}),this}function j(e){var t=arguments;return f["default"].isArray(A.events[e])&&!function(){var n=[].slice.call(t,1);n.unshift(e);var r=(A.events[e]||[]).concat(A.events["*"]||[]);r.forEach(function(e){e.apply(void 0,a(n))})}(),this}var w=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];if(w=l["default"].merge({},m,w),"detect"===w.locale&&v){var S=v.languages;f["default"].isArray(S)&&f["default"].isString(S[0])&&(w.locale=S[0].substr(0,2))}p["default"].supports(w.locale)||(w.locale=p["default"].defaultLocale);var A={options:w,casting:{},status:"ready",onStage:null,currentScene:-1,scenario:[],events:{}};return t(null),Object.freeze(Object.defineProperties({addActor:e,getCurrentActor:n,addScene:r,play:u,replay:o,stop:s,on:x},{options:{get:function(){return A.options},configurable:!0,enumerable:!0},status:{get:function(){return A.status},configurable:!0,enumerable:!0}}))}Object.defineProperty(t,"__esModule",{value:!0});var o=n(3),i=r(o),s=n(2),l=r(s),c=n(1),f=r(c),d=n(5),p=r(d),g=n(4),h=r(g),v="undefined"!=typeof window&&window.navigator,m={autoplay:!0,erase:!0,minSpeed:80,maxSpeed:450,locale:"detect"};u.init=function(){var e=arguments.length<=0||void 0===arguments[0]?"actor":arguments[0],t=u();return t.addActor(e,{accuracy:1,speed:.8}),t},t["default"]=u,e.exports=t["default"]},/*!*****************************!*\
  !*** ./src/helpers/type.js ***!
  \*****************************/
